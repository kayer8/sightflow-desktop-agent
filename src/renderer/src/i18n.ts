...
const translations = {
  zh: {
    ...
    'settings.visionApiKey.placeholder': '输入 OpenAI 或兼容服务 API Key',
    'settings.visionApiKey.hint': '用于布局分析、未读检测、界面定位和内置聊天 Provider',
    'settings.visionModel': '视觉模型',
    'settings.visionBaseUrl': 'AI 服务地址',
  ...
  en: {
    ...
    'settings.visionApiKey.placeholder': 'Enter an OpenAI or compatible API key',
    'settings.visionApiKey.hint': 'Used for layout measurement, UI detection, and the built-in chat provider',
    'settings.visionModel': 'Vision Model',
    'settings.visionBaseUrl': 'AI Base URL',
